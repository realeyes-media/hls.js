...
module.exports = {
  ...
  */
  angelOneShakaWidevine: createTestStreamWithConfig({
    ...
    emeEnabled: true,
    requestMediaKeySystemAccessFunc: function requestMediaKeySystemAccessFunc(supportedConfigurations) {
      var keySystem = 'com.widevine.alpha';
      return window.navigator.requestMediaKeySystemAccess(keySystem, supportedConfigurations);
    },
    getEMEInitializationDataFunc: function getEMEInitializationDataFunc(levelOrAudioTrack, initDataType, initData) {
      return Promise.resolve({
        initDataType: initDataType,
        initData: initData
      });
    },
    getEMELicenseFunc: function getEMELicenseFunc(levelOrAudioTrack, event) {
      var licenseServerUrl = 'https://cwip-shaka-proxy.appspot.com/no_auth';
